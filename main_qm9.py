...
parser.add_argument(
    "--epochs", type=int, default=1000, metavar="N", help="number of epochs to train (default: 10)"
)
...
parser.add_argument(
    "--outf", type=str, default="qm9/logs", metavar="N", help="folder to output vae"
)
...
parser.add_argument(
    "--num_workers", type=int, default=0, metavar="N", help="number of workers for the dataloader"
)
parser.add_argument(
    "--charge_power",
    type=int,
...
parser.add_argument(
    "--dataset_paper", type=str, default="cormorant", metavar="N", help="cormorant, lie_conv"
)
parser.add_argument("--node_attr", type=int, default=0, metavar="N", help="node_attr or not")
parser.add_argument("--weight_decay", type=float, default=1e-16, metavar="N", help="weight decay")
...
def train(epoch, loader, partition="train"):
    ...
    for i, data in enumerate(loader):
        ...
        nodes = qm9_utils.preprocess_input(
            one_hot, charges, args.charge_power, charge_scale, device
        )
